...
local Window = redzlib:MakeWindow({
    Title = "Drip Client Solutions | Leaked by WxDeveloper | Brookhaven Rp 🏡 ",
    SubTitle = "                  Dev < WxDeveloper >",
...
local permissionURL = "https://raw.githubusercontent.com/contasecreta8/Sources_Leakadas/refs/heads/main/Painel"
