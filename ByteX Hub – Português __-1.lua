...
local Window = Libary:MakeWindow({
    Title = "ByteX Hub | Brookhaven RP 🏡",
    SubTitle = "by: ThexDev001",
    LoadText = "Carregando ByteX Hub",
    Flags = "ByteXHub_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://114395494206373", BackgroundTransparency = 0 },
...
InfoTab:AddDiscordInvite({
    Name = "ByteX Hub Studio",
    Description = "Join server",
    Logo = "rbxassetid://114395494206373",
    Invite = "https://discord.gg/ruEdVGsthy",
}) 
InfoTab:AddSection({ "Informações do Script" })
InfoTab:AddParagraph({ "Proprietário / Desenvolvedor:", "ThexDev, Deus" })
InfoTab:AddParagraph({ "Collaborations:", "????" }) 
InfoTab:AddParagraph({ "Obsfucador:", "ByteXAuth" })
InfoTab:AddParagraph({ "Segurança:", "ThexDev, Deus " })
InfoTab:AddParagraph({ "Você está usando:", "ByteX Hub Brookhaven " })
